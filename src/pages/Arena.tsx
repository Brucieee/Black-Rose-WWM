        ...
        <div key={match.id} className="match-card match-card-3d relative flex flex-col items-center z-10 w-full mb-8 last:mb-0 perspective-container group">
            ...
            {canManage && match.player1 && match.player2 && (
                <button 
                    ...
                    className="mb-2 text-[10px] bg-zinc-800 text-zinc-300 hover:text-white hover:bg-rose-900 px-3 py-1.5 rounded flex items-center gap-1 transition-colors shadow-md z-50 relative border border-zinc-700"
                >
                    <Eye size={12} /> Show VS Banner
                </button>
            )}
