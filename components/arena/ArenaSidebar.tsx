...
import { X, Clock, Edit2, Users, Shuffle, RefreshCw, UserMinus, Shield, LogOut, AlertCircle, Trash2, ArrowDownWideNarrow, ArrowUpNarrowWide } from 'lucide-react';
...
export const ArenaSidebar: React.FC<ArenaSidebarProps> = ({
  ...
  const sortedParticipants = [...approvedParticipants].sort((a, b) => {
      const pointsA = a.activityPoints || 0;
      const pointsB = b.activityPoints || 0;
        ...
        <div className="p-4 border-b border-zinc-100 dark:border-zinc-800 flex justify-between items-center flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
                <button 
                    ...
                    title={sortOrder === 'desc' ? "Sort: Highest Points First" : "Sort: Lowest Points First"}
                >
